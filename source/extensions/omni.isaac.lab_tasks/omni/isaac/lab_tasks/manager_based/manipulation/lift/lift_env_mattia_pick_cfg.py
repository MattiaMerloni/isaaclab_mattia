...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    # object_5: RigidObjectCfg = MISSING
    # object_6: RigidObjectCfg = MISSING
    # object_7: RigidObjectCfg = MISSING
    # object_8: RigidObjectCfg = MISSING
    ...
    table = AssetBaseCfg(
        ...
        spawn=UsdFileCfg(usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/SeattleLabTable/table_instanceable.usd", scale=(1.65, 1.80, 1)),
    )
...
class TerminationsCfg:
    ...
    # object_dropping_5 = DoneTerm(
    #     func=mdp.root_height_below_minimum, params={"minimum_height": -0.05, "asset_cfg": SceneEntityCfg("object_5")}
    # )

    # object_dropping_6 = DoneTerm(
    #     func=mdp.root_height_below_minimum, params={"minimum_height": -0.05, "asset_cfg": SceneEntityCfg("object_6")}
    # )

    # object_dropping_7 = DoneTerm(
    #     func=mdp.root_height_below_minimum, params={"minimum_height": -0.05, "asset_cfg": SceneEntityCfg("object_7")}
    # )
