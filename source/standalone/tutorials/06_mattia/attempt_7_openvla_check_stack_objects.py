...
class StackSceneCfg(InteractiveSceneCfg):
    ...
    # # distant light (luce che punta dal lato come se ci fosse una finestra)
    # distant_light = AssetBaseCfg(
    #     prim_path="/World/Light", spawn=sim_utils.DistantLightCfg(intensity=3000.0, color=(0.75, 0.75, 0.75), angle=0.53), init_state=AssetBaseCfg.InitialStateCfg(pos=(0.0, 0.0, 0.0), rot=(1.0, -0.35, -0.15, 0.0)),
    # )
    ...
    # PER TROVARE GLI OGGETTI CHE VENGONO SPAWNATI VAI NEL NUCLEUS E SEGUI IL SEGUENTE PERCORSO: "omniverse://localhost/NVIDIA/Assets/Isaac/4.0/Isaac/Props/Mounts/SeattleLabTable/table_instanceable.usd"
...
def main():
    ...
    # Design scene
    scene_cfg = StackSceneCfg(num_envs=args_cli.num_envs, env_spacing=2.0)
